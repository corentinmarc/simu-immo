...
const MensualityTableHeader: SFC<Props> = () => (
  <div className={classnames(styles.line, styles['line-header'])}>
    ...
    <div className={classnames(styles['line-cost-capital'])}>
      Capital rembours&eacute;
    </div>
    <div className={classnames(styles['line-cost-interest'])}>
      Co&ucirc;t int&eacute;r&ecirc;t
    </div>
    <div className={classnames(styles['line-cost-insurance'])}>
      Co&ucirc;t assurance
    </div>
    <div className={classnames(styles['line-cost-cumul'])}>
      Co&ucirc;t cumul&eacute;
    </div>
