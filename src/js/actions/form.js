...
export const setInterestRate = ({ interestRate }) => actionCreator(SET_INTEREST_RATE, { interestRate });
export const setInsuranceRate = ({ insuranceRate }) => actionCreator(SET_INSURANCE_RATE, { insuranceRate });
